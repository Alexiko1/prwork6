...
<body>
    ...
    <tr>
        ...
        <p>
            Таблицы демонстрируют работу PHP с типами данных, операторами сравнения и логическими операторами.<br>
            !A - отрицание, если $a не true.<br>
            A || B - ИЛИ, если или $a, или $b — true.<br>
            A && B - И, если и $a, и $b — true.<br>
            A xor B - исключающее ИЛИ, если $a или $b — true, но не оба.<br>
            При нестрогом сравнении оператор осуществляет приведение между двумя различными типами, если они различаются. То есть он сравнивает значение после преобразования типов.<br>
